...
std::tuple<dai::Pipeline, int, int> createPipeline(bool lrcheck, bool extended, bool syncNN, bool subpixel, 
    std::string nnPath, std::string nnConfigPath, int confidence, int LRchecktresh, std::string resolution,
    bool publish_grayscale_image, bool publish_depth_image) {
