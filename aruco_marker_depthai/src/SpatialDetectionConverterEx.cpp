...
SpatialDetectionConverterEx::~SpatialDetectionConverterEx() = default;

void SpatialDetectionConverterEx::updateRosBaseTime() {
...
void SpatialDetectionConverterEx::toRosVisionMsg(std::shared_ptr<dai::SpatialImgDetections> inNetData,
