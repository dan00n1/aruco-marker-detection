...
def generate_launch_description():
    # default_rviz = os.path.join(get_package_share_directory('aruco_marker_depthai'), 'rviz', 'stereoDetectedMarkersPointCloud.rviz')
    ...
    #     package='aruco_marker_depthai', executable='stereo_node',
    #     output='screen',
