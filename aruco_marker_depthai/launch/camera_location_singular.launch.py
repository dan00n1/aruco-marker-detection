...
def generate_launch_description():
    default_rviz = os.path.join(get_package_share_directory('aruco_marker_depthai'), 'rviz', 'stereoCameraLocationSingular.rviz')
    ...
    camera_location_singular_marker = launch_ros.actions.Node(package='aruco_marker_depthai', executable='camera_location_singular_marker.py', output='screen')
    ...
    ld.add_action(camera_location_singular_marker)
